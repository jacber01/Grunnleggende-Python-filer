...
Modellen får data fra tidsperioden og får beskjed om å dele denne perioden i enten regime 1 eller regime 0 (modellen ser på variablene, og velger selv hvilket regime det tilhører). Det regime med lavest gjennomsnittsvolatilitet klassifiserer vi som "rolig" og det med høyest volatilitet klassifiserer vi som "turbulent".
