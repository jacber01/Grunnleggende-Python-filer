...
*Ekstra*  
Hvis du vil hente ut og teste modellen på nyeste dataen for Oslo børs gjør følgende:  

4. Kjør `data_eksport.py`  
5. Pass på at den nye og oppdaterte csv-filen ligger i samme mappe som `markov_kjede.py` og kjør den på nytt  
